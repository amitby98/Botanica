...
// var freqcheck = ["sid", "preferredFirstName", "currentLastName", "secondaryEmail", "city", "state", "country"];
// $(document).ready(function () {
//   $("#filtersection").hide();
//   $("#filtertags").hide();
...
//       });
//   });
//   $("#freqselect").click(function () {
//     $("input:checkbox").each(function () {
//       $(this).prop("checked", false);
//     });
//     for (var k = 0; k < freqcheck.length; k++) {
//       $("#" + freqcheck[k]).prop("checked", true);
//     }
//   });
...
//     $("#filtertags").show();
//     $("#tagsinput").tagsinput("add", $("#filtergroup span").text() + ":" + $("#filtergroup input").val());
//   });

//   $("#search").click(function () {
//     if (typeof $("#keywords").val() !== "undefined" && $.trim($("#keywords").val()) != "") {
//       displaySearch();
...
//     if (typeof $(this).children("a").attr("alt") !== "undefined") {
//       if (parseInt($(this).children("a").attr("alt")) < 100) {
//         invokeSearch("0", $(this).children("a").attr("alt"));
//         $("#pagination").hide();
//       }
//     }
//   });
...
//     $("#next").show();
//     if ($(this).attr("alt") >= 0) {
//       $("#previous").attr("alt", parseInt($("#previous").attr("alt")) - 10);
//       $("#next").attr("alt", parseInt($("#next").attr("alt")) - 10);
//       $("#resultstable").html('<img width="50" height="50" alt="Loading" src="/images/alumni/spin.gif">');
//       invokeSearch($(this).attr("alt"), "10");
//       $("#pagnum").html("Showing " + (parseInt($(this).attr("alt")) + 1) + " to " + $("#next").attr("alt"));
//       if (parseInt($(this).attr("alt")) - 10 < 0) {
//         $("#previous").hide();
//       }
//     }
//   });
...
//   $("#next").click(function () {
//     $("#previous").show();
//     if (parseInt($(this).attr("alt")) < parseInt($("#searchmessage").children("a").attr("alt"))) {
//       $("#resultstable").html('<img width="50" height="50" alt="Loading" src="/images/alumni/spin.gif">');
//       invokeSearch($(this).attr("alt"), "10");

//       if (parseInt($(this).attr("alt")) + 10 >= parseInt($("#searchmessage").children("a").attr("alt"))) {
//         $("#next").hide();
//         $("#pagnum").html("Showing " + (parseInt($(this).attr("alt")) + 1) + " to " + $("#searchmessage").children("a").attr("alt"));
//       } else {
//         $("#pagnum").html("Showing " + (parseInt($(this).attr("alt")) + 1) + " to " + (parseInt($("#next").attr("alt")) + 10));
//       }
...
//   invokeSearch("0", "10");
// }
// function invokeSearch(start, rows) {
//   var searchUrlBase = "/alumni/app/admin/search?wt=json&";
//   var exportUrlBase = "/alumni/app/admin/export?";
//   var queryStr = "q=" + $("#keywords").val() + "&start=" + start;
//   var rowsQry = "&rows=" + rows;
//   var thead = "<thead><tr>";
//   $(".bootstrap-tagsinput span").each(function () {
//     if ($(this).text() != "") {
//       queryStr = queryStr + "&fq=" + $(this).text();
//     }
//   });
...
//     }
//   }
//   queryStr = queryStr + "&fl=aid,";
//   var columns = ["aid"];
//   thead = thead + "<th>Profile</th>";
//   $("input:checked").each(function () {
//     queryStr = queryStr + this.id + ",";
//     var splittedString = this.id.replace(/([A-Z]+)/g, " $1").replace(/([A-Z][a-z])/g, " $1");
//     var userFriendlyTHead = splittedString.charAt(0).toUpperCase() + splittedString.slice(1);
//     thead = thead + "<th>" + userFriendlyTHead + "</th>";
...
//   var tbody = "<tbody>";
//   // $.get(searchUrlBase + queryStr + rowsQry, function (json) {
//   var jsondata =
//     '{"responseHeader":{"status":0,"QTime":191,"params":{"fl":"aid,sid,preferredFirstName,currentLastName,secondaryEmail,city,country,state,","start":"0","q":"new york","q.op":"AND","wt":"json","rows":"10"}},"response":{"numFound":6737,"start":0,"docs":[{"sid":"AFPLC7P8YB","aid":"nfhqjru667","preferredFirstName":"Malika","currentLastName":"Kerstin","secondaryEmail":"Malika.Kerstin@fakemail.com","city":"NEW YORK","country":"United States of America","state":"New York"},{"sid":"W50SKEB5G3","aid":"yaf65hw2sb","preferredFirstName":"Judith","currentLastName":"Roy","secondaryEmail":"Judith.Roy@fakemail.com","city":"New York","country":"United States of America","state":"New York"},{"sid":"J3PWSUFVNB","aid":"kguz9x8orq","preferredFirstName":"Vernon","currentLastName":"Kathe","secondaryEmail":"Vernon.Kathe@fakemail.com","city":"New York","country":"United States of America","state":"New York"},{"sid":"W00W1EFT2J","aid":"jj1xc9tfe8","preferredFirstName":"Elda","currentLastName":"Anna","secondaryEmail":"Elda.Anna@fakemail.com","city":"NEW YORK","country":"United States of America","state":"New York"},{"sid":"APQUVDN767","aid":"vwzngyccuc","preferredFirstName":"Clarence","currentLastName":"Joetta","secondaryEmail":"Clarence.Joetta@fakemail.com","city":"New York","country":"United States of America","state":"New York"},{"sid":"Y3HN21YTML","aid":"gvvc0swvge","preferredFirstName":"Shani","currentLastName":"India","secondaryEmail":"Shani.India@fakemail.com","city":"New York","country":"United States of America","state":"New York"},{"sid":"EGWMW8E527","aid":"h303s1yus3","preferredFirstName":"Therese","currentLastName":"Anamaria","secondaryEmail":"Therese.Anamaria@fakemail.com","city":"NEW YORK","country":"United States of America","state":"New York"},{"sid":"T3NDTNMEAP","aid":"l5gvc20yz8","preferredFirstName":"Brunilda","currentLastName":"Kaleigh","secondaryEmail":"Brunilda.Kaleigh@fakemail.com","city":"New York","country":"United States of America","state":"New York"},{"sid":"JKCZB7APTQ","aid":"bmvjwarepv","preferredFirstName":"Jona","currentLastName":"Tess","secondaryEmail":"Jona.Tess@fakemail.com","city":"New York","country":"United States of America","state":"New York"},{"sid":"5GO3VM6Y1Q","aid":"mgamgmi9iq","preferredFirstName":"Raven","currentLastName":"Alexa","secondaryEmail":"Raven.Alexa@fakemail.com","city":"New York","country":"United States of America","state":"New York"}]}}';
...
//         if (j == 0) {
//           tbody = tbody + "<td><a href='#" + docs[i][columns[j]] + "'>View</a> | <a href='#" + docs[i][columns[j]] + "'>Edit</a></td>";
//         } else {
//           tbody = tbody + "<td>" + docs[i][columns[j]] + "</td>";
//         }
//       }
//       tbody = tbody + "</tr>";
//     }
...
//     if (rows < json.response.numFound) {
//       if (json.response.numFound > 100) {
//         $("#searchmessage").html("Found <strong>" + json.response.numFound + "</strong> results. <a href='#' alt='" + json.response.numFound + "' id='viewall'></a>");
//       } else {
//         $("#searchmessage").html("Found <strong>" + json.response.numFound + "</strong> results. <a href='#' alt='" + json.response.numFound + "' id='viewall'>View All</a>");
//       }
//     } else {
//       $("#searchmessage").html("Showing all results");
//     }
//     $("#resultstable").html(thead + tbody);
//     $("#exportlink").show();
//     //$("#exportlink").attr("href", exportUrlBase + queryStr + "&rows=" + json.response.numFound);
//     $("#exportlink").attr("href", "#");
//   } else {
//     $("#searchmessage").html("Sorry, no results were found");
//     $("#exportlink").hide();
//     $("#resultstable").html("");
//   }
//   if (typeof $("#searchmessage").children("a").attr("alt") === "undefined") {
//     $("#pagnum").html("");
//     $("#next").hide();
//     $("#previous").hide();
//   }
